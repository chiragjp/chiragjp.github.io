...
#### [Non-linear relationships between physiological indicators and all-cause mortality](https://chiragjp.shinyapps.io/%20nhanes_mortality_associations/)
...
#### [Data-driven characterization of exposome risk variables for type 2 diabetes](https://chiragjp.shinyapps.io/t2d_relative_risk_variables/)
...
Developing new computational approach for predicting new drug repositioning candidates? Test your predictions with our standard database for drug repositioning. GitHub
...
PXStools provides an analytical package to standardize exposome-wide studies as well as derive and validate polyexposure risk scores. {{< fa brands github >}} [PXSTools](https://github.com/yixuanh/PXStools)
